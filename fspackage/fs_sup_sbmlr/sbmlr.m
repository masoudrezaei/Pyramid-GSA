...
%        regression via Bayesian regularisation using a Laplace prior",
%        Neural Information Processing Systems (in progress), 2006.
%
...
% History     :
%
% To Do List  : gc terminates if a stable zero is located
% 
%               make gradient computation faster in gc
%
%               outer loop tries to insert as many features as possible
